module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        cssmin: {
            ...
            target: {
                src: [
                    "src/css/libs/spa.css",
                    "src/css/libs/app.css",
                    "src/css/libs/ui/*.css",
                    "src/css/dev/core/grid.css",
                    "src/css/dev/core/list.css",
                    "src/css/dev/core/typography.css",
                    "src/css/dev/core/form.css",
                    "src/css/dev/core/buttons.css",
                    "src/css/dev/core/code.css",
                    "src/css/dev/ui/*.css",
                    "src/css/dev/views/*.css"
                ],
                dest: 'src/css/love2dev.min.css'
            }
        },
        less: {
            dev: {
                options: {
                    ...
                    //         compress: true,
                    banner: "//Copyright 2016 Love2Dev.com\r\n"
                },
                files: [{
                    expand: true,
                    cwd: "src/less/",
