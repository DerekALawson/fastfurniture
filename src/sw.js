var appCache = 'fast-furninture-app',
  productImages = "fast-furniture-images",
  filesToCache = [
    "index.html",
...
function cacheImage(response) {
  ...
  caches.open(productImages).then(function (cache) {
...
self.addEventListener('fetch', function (event) {
  ...
  if (url.hostname === "localHost") {
    ...
    //pass through to facilitate development
    event.respondWith(
