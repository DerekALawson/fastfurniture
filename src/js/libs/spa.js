...
(function (window, undefined) {
    ...
    SPA.fn = SPA.prototype = {
        ...
        //this can be moved to a utility like dollarbill
        ...
        getExistingView: function (newLayout) {
            ...
            var spa = this
            view = document.querySelector(leadingDot + spa.settings.currentLayoutClass);

            if (!view) {
                view = document.querySelector(leadingDot + spa.settings.currentViewClass);
            }
        ...
        swapView: function () {
            ...
            if (oldLayout) {
                ...
                if (oldLayout && oldLayout.getAttribute(spa.settings.layoutClass) !== route.layout) {
...
//                currentView = document.querySelector(leadingDot + spa.settings.currentViewClass + ".out"),
        ...
        stampView: function (currentView, route) {
            ...
            var spa = this,
				view,
				currentLayout,
                layoutSelector = "[spa-layout='" + route.layout + "']",
				newView, loc;
            ...
            if (spa.viewEngine) {
                ...
                if (route.layout) {
                    ...
                    currentLayout = document.querySelector(layoutSelector);

                    if (currentLayout) {

                        loc = currentLayout.querySelector(spa.settings.layOutPlaceholder);

                        if (currentView && !currentView.classList.contains(spa.settings.layoutClass)) {
        ...
        //move to utility module like dollarbill
